  ...
  const menuItems = [
    {
      title: 'Inscription',
      icon: '📝',
      description: 'Fiche Pédagogique ISEM',
    ...
    },
    {
      title: 'Paiements',
      icon: '💳',
      description: 'En ligne & Import Reçu',
    ...
    },
    {
      title: 'Réclamations',
      icon: '📣',
      description: 'Suivi des requêtes',
    ...
    },
    {
      title: 'Justificatifs',
      icon: '📄',
      description: 'Absences & Certificats',
    ...
    },
    {
      title: 'Services UGB',
      icon: '🌐',
      description: 'Liens externes utiles',
      ...
      <header className="bg-brown-dark text-cream shadow-2xl relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 py-6 flex items-center justify-between relative z-10">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="font-black text-xl tracking-tight">Portefeuille Étudiants ISEM UGB</h1>
              <p className="text-brown-light text-[10px] font-bold uppercase tracking-widest">Université Gaston Berger</p>
            </div>
          </div>
        ...
        <div className="bg-white rounded-[2.5rem] shadow-2xl p-8 mb-10 border border-brown-light/10 relative overflow-hidden group">
          ...
          <div className="flex flex-col md:flex-row items-center gap-8 relative z-10">
            ...
            <div className="text-center md:text-left flex-1">
              <p className="text-brown-medium font-bold text-xs uppercase tracking-[0.2em] mb-1">Espace Étudiant</p>
              <h2 className="text-3xl font-black text-brown-dark mb-2">
                Ravi de vous revoir, {etudiant.prenom} !
              </h2>
              <div className="flex flex-wrap justify-center md:justify-start gap-3">
                ...
                <span className="bg-cream text-brown-dark text-[10px] font-bold px-4 py-1.5 rounded-full border border-brown-light/20">
                  {etudiant.niveau}
                </span>
              </div>
            </div>
            <div className="hidden lg:block bg-brown-dark/5 p-4 rounded-3xl border border-brown-light/10">
              <p className="text-[10px] font-black text-brown-medium uppercase tracking-widest mb-1">Statut Année</p>
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center gap-6">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <p className="text-brown-light text-sm font-medium">
                Les inscriptions pédagogiques pour le semestre 2 sont ouvertes. Assurez-vous de valider votre fiche avant le <span className="text-cream font-bold underline">28 février 2026</span>.
              </p>
            </div>
